...
`dpc-exporter_hail_probability{scope="home"} > 0.5`.
...
| Metric | Meaning |
| --- | --- |
| `dpc-exporter_hail_probability{scope}` | DPC POH, 0–1 |
| `dpc-exporter_reflectivity_dbz{scope}` | DPC VMI, column-max reflectivity |
| `dpc-exporter_vil_kgm2{scope}` | DPC VIL, vertically integrated liquid |
| `dpc-exporter_frame_timestamp_seconds` | Unix time of the sample (staleness) |
